...
const (
	...
	Analysis_GetFunctionInfoInGoroutine_FullMethodName = "/analysis.v1.Analysis/GetFunctionInfoInGoroutine"
	Analysis_GetModuleNames_FullMethodName             = "/analysis.v1.Analysis/GetModuleNames"
)
...
func (c *analysisClient) GetParentFunctions(ctx context.Context, in *GetParentFunctionsReq, opts ...grpc.CallOption) (*GetParentFunctionsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetParentFunctionsReply)
	err := c.cc.Invoke(ctx, Analysis_GetParentFunctions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analysisClient) SearchFunctions(ctx context.Context, in *SearchFunctionsReq, opts ...grpc.CallOption) (*SearchFunctionsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchFunctionsReply)
	err := c.cc.Invoke(ctx, Analysis_SearchFunctions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analysisClient) GetFunctionInfoInGoroutine(ctx context.Context, in *GetFunctionInfoInGoroutineReq, opts ...grpc.CallOption) (*GetFunctionInfoInGoroutineReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFunctionInfoInGoroutineReply)
	err := c.cc.Invoke(ctx, Analysis_GetFunctionInfoInGoroutine_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analysisClient) GetModuleNames(ctx context.Context, in *GetModuleNamesReq, opts ...grpc.CallOption) (*GetModuleNamesReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetModuleNamesReply)
	err := c.cc.Invoke(ctx, Analysis_GetModuleNames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalysisServer) GetParentFunctions(context.Context, *GetParentFunctionsReq) (*GetParentFunctionsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetParentFunctions not implemented")
}
...
func (UnimplementedAnalysisServer) SearchFunctions(context.Context, *SearchFunctionsReq) (*SearchFunctionsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchFunctions not implemented")
}
func (UnimplementedAnalysisServer) GetFunctionInfoInGoroutine(context.Context, *GetFunctionInfoInGoroutineReq) (*GetFunctionInfoInGoroutineReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFunctionInfoInGoroutine not implemented")
}
func (UnimplementedAnalysisServer) GetModuleNames(context.Context, *GetModuleNamesReq) (*GetModuleNamesReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetModuleNames not implemented")
}
...
func _Analysis_GetParentFunctions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetParentFunctionsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServer).GetParentFunctions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analysis_GetParentFunctions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServer).GetParentFunctions(ctx, req.(*GetParentFunctionsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Analysis_SearchFunctions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchFunctionsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServer).SearchFunctions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analysis_SearchFunctions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServer).SearchFunctions(ctx, req.(*SearchFunctionsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Analysis_GetFunctionInfoInGoroutine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFunctionInfoInGoroutineReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServer).GetFunctionInfoInGoroutine(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analysis_GetFunctionInfoInGoroutine_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServer).GetFunctionInfoInGoroutine(ctx, req.(*GetFunctionInfoInGoroutineReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Analysis_GetModuleNames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetModuleNamesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServer).GetModuleNames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analysis_GetModuleNames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServer).GetModuleNames(ctx, req.(*GetModuleNamesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Analysis_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFunctionInfoInGoroutine",
			Handler:    _Analysis_GetFunctionInfoInGoroutine_Handler,
		},
		{
			MethodName: "GetModuleNames",
			Handler:    _Analysis_GetModuleNames_Handler,
		},
	},
