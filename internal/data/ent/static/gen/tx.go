...
func (tx *Tx) init() {
	tx.FuncEdge = NewFuncEdgeClient(tx.config)
	tx.FuncNode = NewFuncNodeClient(tx.config)
}
...
// applies a query, for example: FuncEdge.QueryXXX(), the query will be executed
