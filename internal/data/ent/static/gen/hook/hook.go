...
// The FuncEdgeFunc type is an adapter to allow the use of ordinary
// function as FuncEdge mutator.
type FuncEdgeFunc func(context.Context, *gen.FuncEdgeMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f FuncEdgeFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.FuncEdgeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.FuncEdgeMutation", m)
}

// The FuncNodeFunc type is an adapter to allow the use of ordinary
// function as FuncNode mutator.
type FuncNodeFunc func(context.Context, *gen.FuncNodeMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f FuncNodeFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.FuncNodeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.FuncNodeMutation", m)
}
